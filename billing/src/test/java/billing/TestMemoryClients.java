...
public class TestMemoryClients {
	...
	/*
	 * @Test public void
	 * whenSavingClients_thenEveryClientsReturnedByGetClientsAreCorrect() { Random
	 * rand = new Random(); int nbOfClients = rand.nextInt(10 - 1 + 1) + 1;
	 * ArrayList<String> array = new ArrayList<>();
	 * 
	 * for (int i = 0; i < nbOfClients; i++) { array.add("client" + i);
